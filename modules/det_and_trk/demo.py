		...
		if len(tracklets) > 0:
			...
			if frame_idx%10 == 0:
				...
				for tracklet in tracklets:
					...
					plt.imsave(os.path.join(save_folder, str(frame_idx)+'.jpg'), img_rbg)
			# 保存到输出视频
			for j, (tracklet, conf) in enumerate(zip(tracklets, confs)):
				bbox = tracklet[0:4]
				id = tracklet[4]
...
if __name__=='__main__':
	demo(data_root='/home/xzy/projects/Worksite_Monitors/test_data/2021湖人vs勇士', video_name='clip0.mp4')