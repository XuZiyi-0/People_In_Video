...
class MuDeep_v2(nn.Module):
    ...
    def forward(self, x, test=False):
        ...
        # #########################################
        fea_1_g_0 = self.scale1.feature(fea_1_g).squeeze(2).squeeze(2)
        fea_1_l_0 = self.scale1_1.feature(fea_1_l[:,:,0,:].unsqueeze(dim=2)).squeeze(2).squeeze(2)
        fea_1_l_1 = self.scale1_2.feature(fea_1_l[:,:,1,:].unsqueeze(dim=2)).squeeze(2).squeeze(2)
        fea_1_l_2 = self.scale1_3.feature(fea_1_l[:,:,2,:].unsqueeze(dim=2)).squeeze(2).squeeze(2)

        fea_2_g_0 = self.scale2.feature(fea_2_g).squeeze(2).squeeze(2)
        fea_2_l_0 = self.scale2_1.feature(fea_2_l[:,:,0,:].unsqueeze(dim=2)).squeeze(2).squeeze(2)
        fea_2_l_1 = self.scale2_2.feature(fea_2_l[:,:,1,:].unsqueeze(dim=2)).squeeze(2).squeeze(2)
        fea_2_l_2 = self.scale2_3.feature(fea_2_l[:,:,2,:].unsqueeze(dim=2)).squeeze(2).squeeze(2)

        fea_3_g_0 = self.scale3.feature(fea_3_g).squeeze(2).squeeze(2)
        fea_3_l_0 = self.scale3_1.feature(fea_3_l[:,:,0,:].unsqueeze(dim=2)).squeeze(2).squeeze(2)
        fea_3_l_1 = self.scale3_2.feature(fea_3_l[:,:,1,:].unsqueeze(dim=2)).squeeze(2).squeeze(2)
        fea_3_l_2 = self.scale3_3.feature(fea_3_l[:,:,2,:].unsqueeze(dim=2)).squeeze(2).squeeze(2)
